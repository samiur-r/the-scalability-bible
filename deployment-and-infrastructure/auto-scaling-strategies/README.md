...
**Auto-scaling** dynamically adjusts the number of instances or containers based on load.

---

## 🧰 How to Use

- Define metrics like CPU, memory, request count
- Configure scale policies in Kubernetes HPA or AWS Auto Scaling
...
- Optimize costs during low demand
- Improve performance without over-provisioning
